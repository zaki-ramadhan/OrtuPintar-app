          ...
          <div className="flex-1 flex flex-col justify-center space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Create your OrtuPintar account and unlock expert guidance, milestone tracking, 
                and personalized support for your child's development.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                { icon: "🎯", text: "Personalized milestone tracking for your child's age" },
                { icon: "👩‍⚕️", text: "Direct access to pediatric development experts" },
                { icon: "📚", text: "1000+ age-appropriate learning activities" },
                { icon: "📊", text: "Detailed progress reports and insights" }
              ].map((benefit, index) => (
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-6 border border-emerald-200">
              <h3 className="font-bold text-emerald-800 mb-2">🎁 Start with 14-day free trial</h3>
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
              ...
              <div className="lg:hidden flex items-center justify-center mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-xl font-bold text-gray-900">OrtuPintar</span>
                </div>
              </div>
              ...
              <form className="space-y-6">
                    ...
                    >
                      {showPassword ? (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.956 9.956 0 012.175-6.125M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-start space-x-3">
                    ...
                    />
                    <span className="text-sm text-gray-600">
                      I'd like to receive parenting tips and product updates via email
                    </span>
                  </label>
                </div>
