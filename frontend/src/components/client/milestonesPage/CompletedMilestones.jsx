...
export default function CompletedMilestones({
    ...
    const milestonesWithDetails = safeCompletedMilestones.map(completed => {
        ...
        return {
            ...completed,
            title: activity?.title || 'Unknown Milestone',
            ...
            <div className="flex items-center space-x-4 flex-1">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className={`text-xs px-2 py-1 rounded-full ${getDifficultyColor(milestone.difficulty)}`}>
                            {milestone.difficulty}
                        </span>
                    </div>
                    <p className="text-sm text-gray-600 mt-1">
                        {formatTimeAgo(milestone.achieved_at)} • {milestone.duration}
                    </p>
