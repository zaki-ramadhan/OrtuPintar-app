                ...
                <div className="p-6 space-y-6">
                    ...
                    {isCompleted && (
                        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="font-medium text-emerald-800">Milestone Completed!</span>
                            </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <span className={`inline-block px-3 py-1 rounded-full text-sm border ${getCategoryColor(milestone.category)}`}>
                                {milestone.category}
                            </span>
                        </div>
                        <div>
                            <h4 className="font-semibold text-gray-900 mb-2">Difficulty</h4>
                            <span className={`inline-block px-3 py-1 rounded-full text-sm ${getDifficultyColor(milestone.difficulty)}`}>
