export default function MilestoneOverview({
    ...
    const childAgeInYears = currentChild ? calculateAgeInYears(currentChild.birthDate) : 0;
    ...
    const ageAppropriateRate = ageAppropriateMilestones.length > 0
        ? Math.round((completedAgeAppropriate.length / ageAppropriateMilestones.length) * 100)
        : 0;
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                ...
                <div className="flex items-center space-x-2">
                    <div className="text-2xl">
                        {currentChild?.photoUrl || (currentChild?.gender === "P" ? "👧" : "👦")}
                    </div>
                </div>
            </div>
            ...
            <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600">
                        {completedAgeAppropriate.length} of {ageAppropriateMilestones.length}
                    </span>
                </div>
            ...
            {recentMilestones.length === 0 && (
                <div className="text-center py-6">
                    ...
                    <p className="text-gray-600 font-medium">No milestones achieved yet</p>
