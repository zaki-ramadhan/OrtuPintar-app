...
export default function AddChildModal({ onClose, onAddChild }) {
	...
	const validateForm = () => {
		...
		if (!formData.birthDate) {
			newErrors.birthDate =
				"Please select your child's birth date";
		} else {
			const birthDate =
				new Date(
					formData.birthDate
		...
		if (!formData.avatar) {
			newErrors.avatar =
				"Please choose an avatar for your child";
		}
				...
				<div className="p-6 bg-gray-50 border-t border-gray-200">
					<div className="flex space-x-3">
						<button
							...
							className="flex-1 px-6 py-3 border-2 border-gray-300 rounded-xl text-gray-700 hover:bg-gray-100 transition-colors font-medium"
							disabled={
								isSubmitting
							}
						>
						...
						<button
							...
							className="flex-1 px-6 py-3 bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 transition-colors font-semibold flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
						>
							{isSubmitting ? (
								<>
									<svg
