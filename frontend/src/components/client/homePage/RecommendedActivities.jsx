					...
					(
						...
						>
							...
							<div className="block sm:hidden">
								...
								<button
									className="w-full bg-emerald-50 text-emerald-700 py-2 px-3 rounded-lg hover:bg-emerald-100 transition-colors text-xs font-medium group-hover:bg-emerald-500 group-hover:text-white"
									onClick={() =>
										onStartActivity &&
										onStartActivity(
											activity
							...
							<div className="hidden sm:block">
								<div className="flex items-start space-x-4">
									...
									<div className="flex-1 min-w-0">
										...
										<div className="mt-4">
											<button
												className="w-full bg-emerald-50 text-emerald-700 py-2 px-4 rounded-lg hover:bg-emerald-100 transition-colors text-sm font-medium group-hover:bg-emerald-500 group-hover:text-white"
												onClick={() =>
													onStartActivity &&
													onStartActivity(
														activity
