			...
			<div className="bg-white rounded-xl sm:rounded-2xl shadow border border-gray-200 p-4 sm:p-6">
				...
				<div className="block sm:hidden space-y-3">
					...
					<button
						...
						className="w-full p-4 rounded-xl border-2 border-dashed border-gray-300 hover:border-emerald-400 bg-gray-50 hover:bg-emerald-50 transition-all duration-300"
					>
				...
				<div className="hidden sm:block">
					<div className="flex space-x-4 overflow-x-auto p-4">
						...
						<button
							...
							className="flex-shrink-0 p-4 lg:p-6 rounded-2xl border-2 border-dashed border-gray-300 hover:border-emerald-400 bg-gray-50 hover:bg-emerald-50 transition-all duration-300 hover:scale-105 min-w-[160px] lg:min-w-[180px] group"
						>
