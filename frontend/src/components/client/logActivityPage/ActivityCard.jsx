                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="space-y-3 mb-3">
                            ...
                            <div className="flex items-center">
                                <span className={`inline-flex items-center space-x-1.5 px-2 py-1.5 rounded-full text-xs font-semibold border ${getCategoryColor(activity.category)} shadow-sm`}>
                                    <span>{activity.category === 'Physical' ? '🏃‍♂️' :
                                        activity.category === 'Cognitive' ? '🧠' :
                                            activity.category === 'Social' ? '👥' :
                                                activity.category === 'Language' ? '💬' :
                                                    activity.category === 'Emotional' ? '❤️' :
                                                        activity.category === 'Creative' ? '🎨' : '📋'}</span>
                            ...
                            <div className="space-y-2 text-xs">
                                <div className="flex items-center">
                                    <div className="flex items-center space-x-2 bg-blue-50 px-2 py-1.5 rounded-lg border border-blue-100 w-full sm:w-auto">
                                        ...
                                        <span className="text-blue-600 text-xs sm:text-sm">{formatDateTime(activity.started_at)}</span>
                                    </div>
                                </div>
                                ...
                                {activity.completed_at && (
                                    <div className="flex items-center">
                                        <div className="flex items-center space-x-2 bg-emerald-50 px-3 py-2 rounded-lg border border-emerald-100 w-full sm:w-auto">
                                            ...
                                            <span className="text-emerald-600 text-xs sm:text-sm">{formatDateTime(activity.completed_at)}</span>
                                        </div>
                                    </div>
                                )}
                                ...
                                {activity.duration && (
                                    <div className="flex items-center">
                                        <div className="flex items-center space-x-2 bg-orange-50 px-2 py-1.5 rounded-lg border border-orange-100 w-full sm:w-auto">
                                            ...
                                            <span className="text-orange-600 text-xs sm:text-sm">{activity.duration} minutes</span>
                                        </div>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 mt-4">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <h5 className="text-sm font-semibold text-blue-800 mb-2">Progress Notes</h5>
